...
{    
    ...
    double t=0; //First time step value  
       while (t<T){
            ...
            cout << endl << endl; 
            printmat(Ny,Nx,v); 
             LidDrivenCavity::InnerVorticity(v,s,Nx,Ny,dx,dy); 
...
//            
            ...
            LidDrivenCavity::NextInnerVorticity(v,s,Nx,Ny,dx,dy,dt,Re); 
            ...
            LidDrivenCavity::RecoverInnerVorticity(v,v1,Nx,Ny); 
...
//            cout << endl << endl; 
            ...
            LidDrivenCavity::UpdateInnerStream(s,s1,Nx,Ny); 
